...
_G.packer_plugins = {
  ...
  ["material.vim"] = {
    after = { "nvim-colorizer.lua", "lualine.nvim" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'neoformat', 'nvim-lspinstall', 'nvim-treesitter-context', 'nvim-treesitter'}, { event = "BufRead *" }, _G.packer_plugins)]]
