...
_G.packer_plugins = {
  ...
  ["git-blame.nvim"] = {
    loaded = true,
    path = "/Users/akyrey/.local/share/nvim/site/pack/packer/start/git-blame.nvim"
  },
  ["git-worktree.nvim"] = {
  ...
  ["material.vim"] = {
    after = { "lualine.nvim", "nvim-colorizer.lua" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-lspinstall', 'neoformat', 'nvim-treesitter', 'nvim-treesitter-context'}, { event = "BufRead *" }, _G.packer_plugins)]]
