...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'neoformat', 'nvim-lspinstall', 'nvim-treesitter', 'nvim-treesitter-context', 'vim-fugitive'}, { event = "BufRead *" }, _G.packer_plugins)]]
